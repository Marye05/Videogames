...
const getVideogames = async ( req, res ) => {
    try {
        ...
        // Para que me quede ne un solo array, creo una nueva varible con un array vacio y 
        //le concateno cada uno de los arrays de las respuestas de las promesas.
        let allVideogames = [];
...
// colocar las notas y verificar por tener errores
